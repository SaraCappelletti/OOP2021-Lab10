...
/**
 * This class will contain four utility functions on lists and maps, of which the first one is
 * provided as example.
 * 
 * All such methods take as second argument a functional interface from the Java library
 * (java.util.function).
